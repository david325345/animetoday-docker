...
function getDayLabel(dayOffset) {
  ...
  const dayName = date.toLocaleDateString('en-GB', { timeZone: 'Asia/Tokyo', weekday: 'long' });
  const dateStr = date.toLocaleDateString('en-GB', { timeZone: 'Asia/Tokyo', day: 'numeric', month: 'numeric' });

...
const DEFAULT_RESOLUTIONS = ['1080p', '720p', '4K', '480p', 'DVD'];
...
function sortByGroupPriority(torrents, userPrefs = null) {
  ...
  // If custom sorting disabled or no prefs, use default
  if (!userPrefs?.customSortEnabled) {
    return defaultSort(withMagnet);
  }

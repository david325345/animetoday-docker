...
function formatTopPill(schedule) {
  // today-added items use indexer-provided label directly (S02E03, S02E03-09, Movie, etc.)
  if (schedule.topLabel) return schedule.topLabel;
  ...
  return `<svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="botGrad" x1="0" y1="0" x2="0" y2="1">
        <stop offset="${GRADIENT_START_PCT}%" stop-color="rgba(0,0,0,0)"/>
        <stop offset="100%" stop-color="rgba(0,0,0,${GRADIENT_MAX_ALPHA})"/>
      </linearGradient>
    </defs>
